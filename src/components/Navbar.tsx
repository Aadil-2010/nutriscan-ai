  ...
  return (
    <header className="sticky top-0 z-40 border-b border-slate-800 bg-slate-950/90 backdrop-blur-md">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* ALWAYS-VISIBLE HORIZONTAL SCROLLING TABS (Works on all devices) */}
        <nav className="flex items-center space-x-2 overflow-x-auto py-2 border-t border-slate-800/60 no-scrollbar">
          <button
            onClick={() => setActiveTab('scanner')}
