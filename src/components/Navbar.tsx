...
export const Navbar: React.FC<NavbarProps> = ({
  ...
  const handleMobileSelect = (tab: string) => {
    setActiveTab(tab);
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center space-x-3">
              {/* Mobile Drawer Toggle (Visible only on mobile screens) */}
              <button
                type="button"
                onClick={() => setIsMobileMenuOpen(true)}
                className="p-2 text-slate-300 hover:text-white bg-slate-900 border border-slate-800 rounded-xl md:hidden flex items-center justify-center transition-colors"
                aria-label="Open Mobile Menu"
              >
                <Menu className="w-5 h-5 text-emerald-400" />
              </button>

              {/* Rebranded Brand Logo */}
              <div
          ...
          <div className="relative w-4/5 max-w-xs bg-slate-900 border-r border-slate-800 h-full p-5 flex flex-col justify-between shadow-2xl z-50">
            <div className="space-y-6">
              ...
              <div className="space-y-2">
                <button
                  onClick={() => handleMobileSelect('scanner')}
                ...
                <button
                  onClick={() => handleMobileSelect('health-profile')}
                  className={`w-full text-left px-3.5 py-2.5 rounded-xl text-xs font-bold transition-all flex items-center gap-2.5 ${
                    activeTab === 'health-profile'
                      ? 'bg-emerald-500/10 text-emerald-400 border border-emerald-500/30'
                      : 'text-slate-300 hover:text-white hover:bg-slate-800'
                ...
                <button
                  onClick={() => handleMobileSelect('directory')}
                  className={`w-full text-left px-3.5 py-2.5 rounded-xl text-xs font-bold transition-all flex items-center gap-2.5 ${
                    activeTab === 'directory'
                      ? 'bg-emerald-500/10 text-emerald-400 border border-emerald-500/30'
                      : 'text-slate-300 hover:text-white hover:bg-slate-800'
                ...
                <button
                  onClick={() => handleMobileSelect('calculator')}
                  className={`w-full text-left px-3.5 py-2.5 rounded-xl text-xs font-bold transition-all flex items-center gap-2.5 ${
                    activeTab === 'calculator'
                      ? 'bg-emerald-500/10 text-emerald-400 border border-emerald-500/30'
                      : 'text-slate-300 hover:text-white hover:bg-slate-800'
                ...
                <button
                  onClick={() => handleMobileSelect('guide')}
                  className={`w-full text-left px-3.5 py-2.5 rounded-xl text-xs font-bold transition-all flex items-center gap-2.5 ${
                    activeTab === 'guide'
                      ? 'bg-emerald-500/10 text-emerald-400 border border-emerald-500/30'
                      : 'text-slate-300 hover:text-white hover:bg-slate-800'
                ...
                <button
                  onClick={() => handleMobileSelect('history')}
                  className={`w-full text-left px-3.5 py-2.5 rounded-xl text-xs font-bold transition-all flex items-center gap-2.5 ${
                    activeTab === 'history'
                      ? 'bg-emerald-500/10 text-emerald-400 border border-emerald-500/30'
                      : 'text-slate-300 hover:text-white hover:bg-slate-800'
